    ...
    <div class="container py-5">
        <div class="row g-5">
                ...
                <div class="row g-5">
                    <div class="col-md-6">
                        <div class="blog-item position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ url('themes/theme1/img/blog-1.jpg') }}" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="blog-item position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ url('themes/theme1/img/blog-2.jpg') }}" alt="">
                            <a class="blog-overlay" href="">
                                <h4 class="text-white">Lorem elitr magna stet eirmod labore amet</h4>
                                <span class="text-white fw-bold">Jan 01, 2050</span>
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ url('themes/theme1/img/blog-3.jpg') }}" alt="">
                            <a class="blog-overlay" href="">
                                <h4 class="text-white">Lorem elitr magna stet eirmod labore amet</h4>
                                <span class="text-white fw-bold">Jan 01, 2050</span>
                            </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-primary p-4">
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0" src="{{ url('themes/theme1/img/blog-1.jpg') }}" style="width: 75px;"
                                alt="">
                            <a href=""
                        ...
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0" src="{{ url('themes/theme1/img/blog-2.jpg') }}" style="width: 75px;"
                                alt="">
                            <a href=""
                                class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum
                                dolor sit amet elit
                        ...
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0" src="{{ url('themes/theme1/img/blog-3.jpg') }}" style="width: 75px;"
                                alt="">
                            <a href=""
                                class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum
                                dolor sit amet elit
                ...
                <!-- Image Start -->
                <div class="mb-5">
                    <img src="{{ url('themes/theme1/img/blog-1.jpg') }}" alt="" class="img-fluid rounded">
                </div>
                <!-- Image End -->
