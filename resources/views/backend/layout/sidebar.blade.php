...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="javascrip:void(0)" class="d-block">
                    {{ ucwords(Auth::user()->name) }}
                </a>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button href="route('logout')" class="badge badge-sm badge-warning"
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('farmers.index') }}"
                                ...
                                <p>All Farmers List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('farmers.create') }}"
                                class="nav-link {{ request()->is('farmers/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add New Farmer</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('acquirements.index') }}"
                                class="nav-link {{ request()->is('acquirements') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Acquirements List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('acquirements.create') }}"
                                class="nav-link {{ request()->is('acquirements/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add New Acquirement</p>
                            </a>
                        </li>
                    </ul>
                </li>
