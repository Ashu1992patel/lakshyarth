...
@section('title', 'Edit Acquirement ')
@section('content')
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('acquirements.index') }}">Acquirements (उपार्जन)</a>
                            </li>
                            <li class="breadcrumb-item active">
                                Edit Acquirement (उपार्जन)
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit Acquirement (Existing)</h3>
                            ...
                            <div class="card-body p-0">
                                ...
                                <form method="POST" action="{{ route('acquirements.update', $acquirement->id) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="rst" name="rst"
                                                    placeholder="Enter RST Number" readonly
                                                    value="{{ old('rst', $acquirement->rst) }}" required autocomplete="rst"
                                                    autofocus>
                                            </div>
                                        </div>
                                                ...
                                                <select class="select2" name="farmer_id" id="farmer_id"
                                                    ...
                                                    @foreach ($farmers as $farmer)
                                                        <option value="{{ $farmer->id }}"
                                                            {{ $farmer->id == $acquirement->farmer_id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="select2" name="vehicle_type" id="vehicle_type"
                                                    ...
                                                    <option
                                                        {{ old('vehicle_type', $acquirement->vehicle_type) == 'Tractor' ? 'selected' : '' }}
                                                        value="Tractor">Tractors</option>
                                                    <option
                                                        {{ old('vehicle_type', $acquirement->vehicle_type) == 'Bike' ? 'selected' : '' }}
                                                        value="Bike">
                                                        Bike</option>
                                                    <option
                                                        {{ old('vehicle_type', $acquirement->vehicle_type) == 'Auto' ? 'selected' : '' }}
                                                        value="Auto">
                                                        Auto</option>
                                                    <option
                                                        {{ old('vehicle_type', $acquirement->vehicle_type) == 'Truck' ? 'selected' : '' }}
                                                        value="Truck">
                                                        Truck</option>
                                                    <option
                                                        {{ old('vehicle_type', $acquirement->vehicle_type) == 'Bus' ? 'selected' : '' }}
                                                        value="Bus">
                                                        Bus
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="vehicle_number"
                                                    name="vehicle_number"
                                                    placeholder="Enter Vehicle Number e.g MP20-NJ-2361"
                                                    value="{{ old('vehicle_number', $acquirement->vehicle_number) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="weight" name="weight"
                                                    ...
                                                    value="{{ old('weight', $acquirement->weight) }}"
                                                    autocomplete="weight">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="comment" name="comment"
                                                    placeholder="Other?"
                                                    value="{{ old('comment', $acquirement->comment) }}"
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                @if ($acquirement->rst_file_status)
                                    <img src="{{ url($acquirement->rst_file) }}" id="rst_file_preview"
                                        alt="RST File Preview" class="table-avatar" width="300px">
                                @else
